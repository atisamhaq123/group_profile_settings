...
$formclass = "\\local_lat_groupprofilesettings\\form\\$tab";
$forminstance = new $formclass($groupdata);

// Render via Moodle renderer (or fallback)
if ($PAGE->get_renderer('local_lat_groupprofilesettings')) {
    $renderer = $PAGE->get_renderer('local_lat_groupprofilesettings');
